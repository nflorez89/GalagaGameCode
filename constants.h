...
const char GAME_TITLE[] = "Scrolling Bitmap";
const bool FULLSCREEN = false;              // windowed or fullscreen
const UINT GAME_WIDTH =  640;               // width of game in pixels
const UINT GAME_HEIGHT = 480;               // height of game in pixels
 
// game
const float BACKDROP_SPEED = 160;
...
const int PLANET_SURFACE_WIDTH = 1200;
const int PLANET_SURFACE_HEIGHT = 600;
...
const char PLANET_IMAGE[] = "pictures\\planetTerminus.png";
const char TEXTURES1_IMAGE[] = "pictures\\textures1.png";  // game textures
const char TEXTURES2_IMAGE[] = "pictures\\textures2.png";
const char MENU_IMAGE[] = "pictures\\menu.png";     // menu texture
const char BOSS_IMAGE[] = "pictures\\bossTextures.png";	// boss textures
...
const UCHAR SHIP1_DOWN_KEY    = VK_DOWN; // down arrow
const UCHAR SHIP1_FIRE_KEY = VK_SPACE;				// Space bar
const UCHAR SHIP1_FIRE_KEY2 = VK_CONTROL;
