...
class Entity : public Image
{
  ...
  public:
	...
	virtual bool getDestroyable() const {return isDestroyable;}
	...
	// set isDestroyable flag
	virtual void setDestroyable(bool destroyable) {isDestroyable = destroyable;}
    ...
    bool bounce(VECTOR2 &collisionVector, Entity &ent);
